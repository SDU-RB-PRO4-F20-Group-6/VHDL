...
################################################################
# This is a generated script based on design: spi_test
#
...
# source spi_test_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# Evenparity, SPI, state_machine
...
proc create_root_design { parentCell } {
  ...
  # Create instance: val_0, and set properties
  set val_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 val_0 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
   CONFIG.CONST_WIDTH {1} \
 ] $val_0

  # Create instance: val_1, and set properties
  set val_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 val_1 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {1} \
   CONFIG.CONST_WIDTH {1} \
 ] $val_1

  # Create instance: val_2, and set properties
  set val_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 val_2 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {2} \
   CONFIG.CONST_WIDTH {15} \
 ] $val_2

  # Create instance: val_3, and set properties
  set val_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 val_3 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {3} \
   CONFIG.CONST_WIDTH {15} \
 ] $val_3
  ...
  connect_bd_net -net clk_in_0_1 [get_bd_ports clk] [get_bd_pins SPI_0/clk_in] [get_bd_pins state_machine_0/clk_in]
  ...
  connect_bd_net -net val_0x0A0A1_dout [get_bd_pins state_machine_0/quad_enc_B] [get_bd_pins val_2/dout]
  connect_bd_net -net val_0x0A0A2_dout [get_bd_pins state_machine_0/index_ctrl_A] [get_bd_pins val_1/dout]
  connect_bd_net -net val_0x0A0A3_dout [get_bd_pins state_machine_0/index_ctrl_B] [get_bd_pins val_0/dout]
  connect_bd_net -net xlconcat_0_dout [get_bd_ports led] [get_bd_pins SPI_0/spi_data_out] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins state_machine_0/quad_enc_A] [get_bd_pins val_3/dout]

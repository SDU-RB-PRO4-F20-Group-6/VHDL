...
HD_PWD='C:/Users/claus/source/semesterprojekt/VHDL/Atrix7/Atrix7.runs/robot_simulation_SPI_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log robot_simulation_SPI_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source robot_simulation_SPI_0_0.tcl

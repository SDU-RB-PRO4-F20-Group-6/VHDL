...
HD_PWD='C:/Users/claus/source/semesterprojekt/VHDL/claus_playground/claus_playground.runs/design_1_SPI_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_SPI_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_SPI_0_0.tcl

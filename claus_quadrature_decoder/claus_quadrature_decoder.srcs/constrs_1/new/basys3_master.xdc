...
#7 segment display
set_property -dict { PACKAGE_PIN W7     IOSTANDARD LVCMOS33 } [get_ports { seg[1] }]					
set_property -dict { PACKAGE_PIN W6     IOSTANDARD LVCMOS33 } [get_ports { seg[2] }]					
...
set_property -dict { PACKAGE_PIN U5     IOSTANDARD LVCMOS33 } [get_ports { seg[5] }]					
set_property -dict { PACKAGE_PIN V5     IOSTANDARD LVCMOS33 } [get_ports { seg[6] }]					
set_property -dict { PACKAGE_PIN U7     IOSTANDARD LVCMOS33 } [get_ports { seg[7] }]					
set_property -dict { PACKAGE_PIN V7     IOSTANDARD LVCMOS33 } [get_ports { seg[8] }]							
...
set_property -dict { PACKAGE_PIN T17    IOSTANDARD LVCMOS33 } [get_ports Lap]						
